...
namespace SccmTools.Tests.UnitTests
{
    ...
    public class ProductCodeProviderTests
    {
        ...
        [Test]
        public void ProductCodeProviderTest1()
        {
            
            using(var testBooStrapper = new TestBootStrapper(GetType()))
            {
                var target = testBooStrapper.Container.Resolve<IProductCodeProvider>();
                const string expected = "{288164B1-EF1F-4113-93D8-8FA2E09D9E34}";
                var actual = target.GetProductCodeFromText("Some comment with a guid in the midle {288164B1-EF1F-4113-93D8-8FA2E09D9E34} somewhere");
                Assert.AreEqual(expected,actual);    
            }
        }

        [Test]
        public void ProductCodeProviderTest2()
        {
            ...
            using(var testBooStrapper = new TestBootStrapper(GetType()))
            {
                var target = testBooStrapper.Container.Resolve<IProductCodeProvider>();
                const string expected = "{288164B1-EF1F-4113-93D8-8FA2E09D9E34}";
                var actual = target.GetProductCodeFromText("{288164B1-EF1F-4113-93D8-8FA2E09D9E34} somewhere at the start");
                Assert.AreEqual(expected,actual);    
            }
        }

        [Test]
        public void ProductCodeProviderTest3()
        {
            ...
            using(var testBooStrapper = new TestBootStrapper(GetType()))
            {
                var target = testBooStrapper.Container.Resolve<IProductCodeProvider>();
                const string expected = "{288164B1-EF1F-4113-93D8-8FA2E09D9E34}";
                var actual = target.GetProductCodeFromText("Some guid at the end {288164B1-EF1F-4113-93D8-8FA2E09D9E34}");
                Assert.AreEqual(expected,actual);    
            }
        }
        ...
        [Test]
        public void ProductCodeProviderTest4()
        {
            ...
            using(var testBooStrapper = new TestBootStrapper(GetType()))
            {
                var target = testBooStrapper.Container.Resolve<IProductCodeProvider>();
                const string expected = "{288164B1-EF1F-4113-93D8-8FA2E09D9E34}";
                var actual = target.GetProductCodeFromText("More than one guid {288164B1-EF1F-4113-93D8-8FA2E09D9E34} and the second {308164B1-EF1F-4113-93D8-8FA2E09D9E40} should be ignored");
                Assert.AreEqual(expected,actual);    
            }
        }
